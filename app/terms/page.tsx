    ...
    <div className="min-h-dvh bg-warm-900 text-zinc-200 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-2xl w-full mx-auto px-5 py-12">
        ...
        <p className="text-[#9A8A7A] text-sm leading-relaxed mb-10">
          These terms are the agreement between you and Sendly. They&rsquo;re written in plain language
        ...
        <Section title="Who we are">
          <p className="text-[#9A8A7A] text-sm leading-relaxed">
            Sendly is a tool for creating digital cards and flyers, made by Asarri, based in Ghana.
        ...
        <Section title="Your account">
          <ul className="space-y-3 text-[#9A8A7A] text-sm leading-relaxed">
            ...
            <li>You must be at least 13 years old to use Sendly.</li>
        ...
        <Section title="What we ask you not to do">
          <ul className="space-y-3 text-[#9A8A7A] text-sm leading-relaxed">
            <li>Don&rsquo;t use Sendly to create content that promotes hate, violence, or illegal activity.</li>
            <li>
        ...
        <Section title="Service availability">
          <ul className="space-y-3 text-[#9A8A7A] text-sm leading-relaxed">
            <li>
              Sendly is offered as-is. We genuinely try to keep it working well,
        ...
        <Section title="Liability">
          <ul className="space-y-3 text-[#9A8A7A] text-sm leading-relaxed">
            <li>
              We&rsquo;re not liable for damages arising from your use of Sendly beyond what&rsquo;s
              required by applicable law.
            </li>
            <li>You use Sendly at your own risk.</li>
          </ul>
        </Section>
        ...
        <Section title="Changes to these terms">
          <p className="text-[#9A8A7A] text-sm leading-relaxed">
            ...
            Continuing to use Sendly after an update means you accept the new terms.
          </p>
        </Section>
